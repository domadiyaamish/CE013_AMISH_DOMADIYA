...
class UserV5 {
  ...
  UserV5({this.id = 0, this.name = "Jogani"});
...
class UserV6 {
  ...
  UserV6({int id = 0, String name = "Jogani"})
      : _id = id,
        _name = name;
...
void main() {
  ...
  */
  ...
  /*
    ...
    // Long-form constructor
    var user1 = UserV1(1, "amish"); // Two arguments are compulsory
    print(user1.id);
    print(user1.name);

    // Short-form constructor
    var user2 = UserV2(2, "amish doamdiya");
    print(user2.id);
    print(user2.name);
