...
/* 
  ...
  print(getMultipleArgument("amish", "doamdiya"));

  //Output:
  // Hello amish, doamdiya
...
/*  
  ...
  print(getFullName("amish", "domadiya"));
  print(getFullName("amish", "doamdiya", "Hello User"));
...
/* 
  ...
  print(getFullName("amish", "domadiya"));
  print(getFullName("amish", "domadiya", "Hi,"));
...
/*  
  ...
  print(greetingsNamed(name: "amish"));
  ...
  print(greetingsNamedRequired(name: "amish"));
...
/* 
  ...
  /// It will take amish as argument and name variable will consider as String variables.
